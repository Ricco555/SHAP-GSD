...
def main() -> None:
    ...
    lines += [
        ...
        "  src/dst novelty SHAP near-zero on UNSW-NB15 (all public IPs, is_internal=0)",
        "",
        "PAPER FRAMING",
        "-------------",
        ...
        "are near-zero on UNSW-NB15 (all nodes are public IPs with is_internal=0),",
        "a known limitation documented in §4.5; on IoT datasets (NF-ToN-IoT) where",
        "novelty is meaningful, these components are expected to dominate.",
        "",
        "CAPTION",
        "-------",
